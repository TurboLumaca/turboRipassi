...
rotazione automatica, ricerca, storico. Il codice \`e coperto da 240 test
...
\texttt{src/**/\_\_tests\_\_/} & 240 test su 21 suite (dettaglio nel cap.~\ref{sec:test}) \\
\bottomrule
\end{tabular}
\end{center}
...
npm test           # 240 test su 21 suite (jest-expo)
