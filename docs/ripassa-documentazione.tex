...
test sulla logica di calcolo (34 test) e ha superato un audit di sicurezza
...
\midrule
\texttt{App.tsx} & gating autenticazione, navigazione stack \\
...
\texttt{src/**/\_\_tests\_\_/} & 34 test jest-expo sulla logica pura \\
\bottomrule
\end{tabular}
\end{center}
...
inferenza estensioni, formattazione date italiane. La logica \`e testabile
perch\'e estratta in moduli puri senza dipendenze native.
