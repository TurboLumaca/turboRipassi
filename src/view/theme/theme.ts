/**
 * App theme — realigned to the LEARN IS identity: a navy/white/grey system
 * with no decorative colour anywhere.
 *
 * Isolated here: no View component defines inline colors. Changing this file
 * changes the entire palette without touching logic.
 *
 * The old palette named a phase of the course by hue — yellow for phase 1,
 ...
 *
 * `primary`/`inkSurface` stay the LEARN IS navy sourced from the
 * white-background sticker (the most reliable of the three reference photos;
 * the projected versions pick up whatever cast the venue's lighting was
 * throwing).
 */
